...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <link href="css/106/iscroll.css" rel="stylesheet" type="text/css" />
        <style>
    ...
    <!--背景音乐-->
        ...
        <div id="todayList">
            ...
            <li class="only4" style="padding:10px 0 0 0">
                   <a href="{{URL('shiti?id=')}}<?php echo $v['c_id'];?>">
                        <div class="img">

                        <img src="<?php                                         if($v['c_name']=="软工学院"){
                                        echo "logo/软工.jpg";
                                    }elseif($v['c_name']=="移动通信学院"){
                                        echo "logo/移动.jpg";
                                    }else if($v['c_name']=="云计算学院"){
                                       echo  "logo/云计算.jpg";
                                    }elseif($v['c_name']=="高翻学院"){
                                        echo  "logo/高翻.jpg";
                                    }elseif($v['c_name']=="国际经贸学院"){
                                        echo  "logo/经贸.jpg";
                                    }elseif($v['c_name']=="建筑学院"){
                                        echo  "logo/建筑.jpg";
                                    }elseif($v['c_name']=="游戏学院"){
                                        echo  "logo/游戏.jpg";
                                    }elseif($v['c_name']=="网工学院"){
                                        echo  "logo/网工.jpg";
                                    }elseif($v['c_name']=="传媒学院"){
                                        echo  "logo/传媒.jpg";
                                    }?>" />
...
<li class="home"><a href="http://v.lanrenmb.com/index.php?g=Wap&m=Index&a=index&token=ieydec1420432915&wecha_id={wechat_id}"></a></li>
